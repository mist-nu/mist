...
void
TransactionWrap::Init(v8::Local<v8::Object> target)
{
...
void
TransactionWrap::getObject(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
  Nan::HandleScope scope;
  ...
  info.GetReturnValue().Set(MistObjectWrap::make(
    self()->getObject(accessDomain, id, includeDeleted)));
}

void
TransactionWrap::query(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
  Nan::HandleScope scope;
...
void
TransactionWrap::queryVersion(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
  Nan::HandleScope scope;
