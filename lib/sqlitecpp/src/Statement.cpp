...
Statement& Statement::operator <<( const int aValue ) {
	bind( ++mLastBoundIndex, aValue );
	return *this;
}

Statement& Statement::operator <<( const unsigned aValue ) {
	bind( ++mLastBoundIndex, aValue );
	return *this;
}

Statement& Statement::operator <<( const long long aValue ) {
	bind( ++mLastBoundIndex, aValue );
	return *this;
}

Statement& Statement::operator <<( const double aValue ) {
	bind( ++mLastBoundIndex, aValue );
	return *this;
}

Statement& Statement::operator <<( const std::string& aValue ) {
	bind( ++mLastBoundIndex, aValue );
	return *this;
}

Statement& Statement::operator <<( const char* aValue ) {
	bind( ++mLastBoundIndex, aValue );
	return *this;
}
